...
if ( comments_open() ) { ?>
    <section id="comments" class="comments">
        <div class="comments-number">
            <h2>
                <?php comments_number( esc_html__( 'Be First to Comment', 'mission-news' ), esc_html__( 'One Comment', 'mission-news' ), esc_html_x( '% Comments', 'noun: 5 comments', 'mission-news' ) ); ?>
            </h2>
        </div>
    ...
    <section id="comments" class="comments">
        ...
        <p class="comments-closed pings-open">
            ...
            printf( __( 'Comments are closed, but <a href="%s" title="Trackback URL for this post">trackbacks</a> and pingbacks are open.', 'mission-news' ), esc_url( get_trackback_url() ) );
            ?>
        </p>
    </section>
    <?php
