	...
	<div id="mission-dashboard-wrap" class="wrap">
		...
		<div class="content-boxes">
			<div class="content content-support">
				...
				<p><?php printf( esc_html__( 'Not sure where to start? The %1$s Support Center is filled with tutorials that will take you step-by-step through every feature in %1$s.', 'mission' ), wp_get_theme( get_template() ) ); ?></p>
				<p>
			...
			<div class="content content-review">
				...
				<p><?php printf( esc_html__( 'Help others find %s by leaving a review on wordpress.org.', 'mission' ), wp_get_theme( get_template() ) ); ?></p>
			...
			<div class="content content-delete-settings">
				...
				<p>
					<?php printf( __( '<strong>Warning:</strong> Clicking this button will erase the %2$s theme\'s current settings in the <a href="%1$s">Customizer</a>.', 'mission' ), esc_url( $customizer_url ), wp_get_theme( get_template() ) ); ?>
				</p>
				<form method="post">
